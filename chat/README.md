...
<img src="docs/img/sd-logo.png" alt="Specific Dynamics" width="420" />
...
The complete aircraft weighs **125 g** (per the documented mass budget), well within the 250 g Transport Canada threshold for registration-exempt recreational operation.

<div align="center">
<img src="docs/img/drone-render.jpg" alt="Exploded and assembled CAD render of the F-17 Humanitarian Hummingbird" width="520" />
</div>
...
| Area | Result |
|---|---|
| **Mass** | 125 g documented build mass — under the 250 g regulatory limit |
| **Thrust-to-weight** | ≈ 2.4 : 1 (exceeds the 2 : 1 design target) |
...
<div align="center">
<img src="docs/img/system-architecture.png" alt="High-level system architecture block diagram" width="380" />
</div>
...
<div align="center">
<img src="docs/img/esc-board-blockdiagram.png" alt="ESC / Airframe board block diagram" width="560" />
</div>
...
<div align="center">
<img src="docs/img/esc-firmware-blockdiagram.png" alt="ESC firmware block diagram" width="620" />
</div>
...
<div align="center">
<img src="docs/img/avionics-board-blockdiagram.png" alt="Avionics / Flight Controller board block diagram" width="460" />
</div>
...
<div align="center">
<img src="docs/img/flightcontroller-firmware-blockdiagram.png" alt="Flight controller firmware block diagram" width="620" />
</div>
...
<div align="center">
<img src="docs/img/controller-board-blockdiagram.png" alt="Handheld controller block diagram" width="380" />
</div>
...
<div align="center">
<img src="docs/img/controller-firmware-blockdiagram.png" alt="Handheld controller firmware block diagram" width="420" />
</div>
...
ESP-NOW was chosen because it is native to the ESP32 already present on the avionics board — zero additional radio hardware on the drone. It provides a connectionless, peer-to-peer, 2.4 GHz transport with no router required.
...
<div align="center">
<img src="docs/img/receiver-arming-statemachine.png" alt="Receiver arming state machine" width="540" />
</div>
...
**Thrust & control authority** — each motor produces ≈ 75 g at full throttle (≈ 300 g system thrust). Against the 125 g mass that is a thrust-to-weight ratio of ≈ **2.4 : 1**, exceeding the 2 : 1 target. Hover requires ≈ 31 g/motor (≈ 42 % throttle), leaving ample headroom for attitude correction and disturbance rejection.
...
- **Weight:** 145 g as-flown configuration measured during testing — comfortably under 250 g (the design mass budget itemises 125 g).
- **Thrust-to-weight:** ≈ 2.3–2.4 : 1, exceeding the 2 : 1 target.
...
<div align="center">
<img src="docs/img/prototype-front.jpg" alt="F-17 prototype, front view" width="380" />
&nbsp;&nbsp;
<img src="docs/img/prototype-side.jpg" alt="F-17 prototype, side view" width="380" />
</div>
